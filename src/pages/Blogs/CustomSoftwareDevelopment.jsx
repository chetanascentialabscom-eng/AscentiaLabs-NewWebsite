          ...
          <div className="max-w-4xl mx-auto">
            <article className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <h2 className="text-3xl  text-gray-800 mb-4 mt-8">What is Custom Software Development?</h2>
                ...
                <div className="grid md:grid-cols-2 gap-6 my-6">
                  <div className="bg-blue-50 p-6 rounded-xl">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl  text-gray-800">Tailored Solutions</h3>
                    </div>
                  ...
                  <div className="bg-green-50 p-6 rounded-xl">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-xl  text-gray-800">Enhanced Security</h3>
                    </div>
                    <p className="text-gray-600">Better security control and data protection measures</p>
                  </div>
                </div>

                <h2 className="text-3xl  text-gray-800 mb-4 mt-8">Key Benefits of Custom Software Development</h2>
                ...
                <h2 className="text-3xl  text-gray-800 mb-4 mt-8">Industries We Serve</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-gray-50 p-4 rounded-lg text-center">
                    <h4 className=" text-gray-800 mb-2">Healthcare</h4>
                    <p className="text-sm text-gray-600">Patient management systems, telemedicine platforms</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg text-center">
                    <h4 className=" text-gray-800 mb-2">Education</h4>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg text-center">
                    <h4 className=" text-gray-800 mb-2">Finance</h4>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg text-center">
                    <h4 className=" text-gray-800 mb-2">Real Estate</h4>
                    <p className="text-sm text-gray-600">Property management, CRM systems</p>
                  </div>
                </div>

                <h2 className="text-3xl  text-gray-800 mb-4 mt-8">Why Choose Ascentia Labs?</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <div className="bg-blue-50 border-l-4 border-blue-600 p-4 my-6 rounded-r-lg">
                  <h4 className=" text-blue-800 mb-2">Our Commitment</h4>
                ...
                <h2 className="text-3xl  text-gray-800 mb-4 mt-8">Getting Started</h2>
                <p className="text-gray-700 leading-relaxed mb-6">
