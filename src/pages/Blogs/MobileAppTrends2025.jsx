              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 mb-6">
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 rounded-xl p-6">
                    <h3 className="text-2xl font-bold text-gray-800 mb-3">1. AI-Powered Mobile Apps</h3>
                  ...
                  <div className="bg-green-50 rounded-xl p-6">
                    <h3 className="text-2xl font-bold text-gray-800 mb-3">2. Cross-Platform Development</h3>
                    <p className="text-gray-700 leading-relaxed">
                  ...
                  <div className="bg-purple-50 rounded-xl p-6">
                    <h3 className="text-2xl font-bold text-gray-800 mb-3">3. 5G Integration</h3>
                    <p className="text-gray-700 leading-relaxed">
                  ...
                  <div className="bg-orange-50 rounded-xl p-6">
                    <h3 className="text-2xl font-bold text-gray-800 mb-3">4. Enhanced Security Features</h3>
                    <p className="text-gray-700 leading-relaxed">
