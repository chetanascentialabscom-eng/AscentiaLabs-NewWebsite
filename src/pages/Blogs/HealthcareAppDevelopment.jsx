              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 mb-6">
                ...
                <div className="space-y-6">
                  <div className="bg-red-50 rounded-xl p-6">
                    <h3 className="text-2xl  text-gray-800 mb-3">Improved Patient Access</h3>
                  ...
                  <div className="bg-blue-50 rounded-xl p-6">
                    <h3 className="text-2xl  text-gray-800 mb-3">Enhanced Patient Engagement</h3>
                    <p className="text-gray-700 leading-relaxed">
                  ...
                  <div className="bg-green-50 rounded-xl p-6">
                    <h3 className="text-2xl  text-gray-800 mb-3">Streamlined Healthcare Operations</h3>
                    <p className="text-gray-700 leading-relaxed">
                  ...
                  <div className="bg-purple-50 rounded-xl p-6">
                    <h3 className="text-2xl  text-gray-800 mb-3">Real-time Health Monitoring</h3>
                    <p className="text-gray-700 leading-relaxed">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6">
                    <h4 className="text-xl  text-gray-800 mb-3">Telemedicine Integration</h4>
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6">
                    <h4 className="text-xl  text-gray-800 mb-3">Electronic Health Records</h4>
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-6">
                    <h4 className="text-xl  text-gray-800 mb-3">Appointment Scheduling</h4>
                    <p className="text-gray-700">Automated booking systems with calendar integration and reminder notifications.</p>
                  </div>
                  <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-6">
                    <h4 className="text-xl  text-gray-800 mb-3">Prescription Management</h4>
                ...
                <div className="bg-yellow-50 rounded-xl p-6 mb-6">
                  <h3 className="text-2xl  text-gray-800 mb-3">Compliance and Security</h3>
                  <p className="text-gray-700 leading-relaxed">
