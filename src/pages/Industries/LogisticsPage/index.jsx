...
const LOGISTICS_FAQ_ITEMS = [
  {
    question: "What is a warehouse management system (WMS)?",
    answer:
      "A warehouse management system (WMS) is software that controls day-to-day warehouse operations — receiving, putaway, picking, packing, and shipping — with real-time inventory visibility. Modern WMS software replaces spreadsheets and manual counts with barcode or RFID tracking across every location.",
  },
  {
    question: "What is the difference between WMS and TMS?",
    answer:
      "WMS software manages inventory and warehouse workflows inside your facilities. A transportation management system (TMS) handles outbound logistics — route planning, carrier selection, dispatch, and shipment tracking. Most logistics teams need both integrated into one logistics management software platform.",
  },
  {
    question: "What is the best warehouse management system for my business?",
    answer:
      "The best warehouse management system depends on your scale, industry, and integration needs. 3PL operators often need multi-client 3PL WMS capabilities, while distributors benefit from warehouse inventory management software tied to ERP. We build custom WMS solutions sized to your operation rather than forcing a one-size-fits-all product.",
  },
  {
    question: "What are the benefits of cloud based WMS?",
    answer:
      "Cloud based WMS and cloud WMS deployments offer faster rollout, lower upfront infrastructure costs, and automatic updates. Teams access inventory and warehouse management software from any device, scale storage during peak seasons, and connect remote warehouses without on-premise servers.",
  },
  {
    question: "What does fleet management software do?",
    answer:
      "Fleet management software and vehicle fleet management software track vehicles with GPS fleet tracking, schedule fleet maintenance software alerts, monitor fuel usage, and assign drivers. A fleet management system gives dispatchers live visibility and helps reduce idle time, breakdowns, and compliance gaps.",
  },
  {
    question: "What is TMS software for trucking companies?",
    answer:
      "TMS software for trucking — also called tms trucking software — handles load planning, dispatch, driver assignment, freight billing, and proof of delivery. Transportation management system tools optimize routes, compare carrier rates, and keep customers informed with live shipment status.",
  },
  {
    question: "What is supply chain management software?",
    answer:
      "Supply chain management software (SCM software) connects procurement, warehousing, transportation, and delivery into one view. Combined with supply chain ERP integration, SCM software surfaces bottlenecks, forecasts demand, and coordinates partners across the full logistics network.",
  },
  {
    question: "What is 3PL WMS and who needs it?",
    answer:
      "3PL WMS is warehouse management software built for third-party logistics providers managing inventory for multiple clients. It supports client-specific billing, segregated stock, branded portals, and SLA reporting — essential when you operate as a fulfillment partner rather than a single-brand warehouse.",
  },
  {
    question: "Can your WMS and TMS integrate with SAP or Oracle ERP?",
    answer:
      "Yes — we build API-first WMS and TMS platforms that integrate with SAP, Oracle, Microsoft Dynamics, and other supply chain ERP systems. Orders, inventory levels, and shipment data sync automatically so your warehouse, fleet, and finance teams share one source of truth.",
  },
  {
    question: "How much does custom logistics software cost and how long does implementation take?",
    answer:
      "Cost depends on modules — WMS only, TMS only, or a unified platform with fleet and SCM. Most projects range from 10–16 weeks for a single site to 20+ weeks for multi-warehouse rollouts. We provide a fixed-scope proposal after assessing your operations, integrations, and go-live timeline.",
  },
];
...
const LogisticsPage = () => {
  ...
  const businessChallenges = [
    {
      icon: Warehouse,
      title: "Fragmented WMS, TMS, and fleet tools",
      pain: "Data silos and duplicate entry across disconnected systems.",
      solution: "One logistics management software platform unifying warehouse, transport, and fleet.",
    },
    {
      icon: Package,
      title: "Manual inventory and stock counts",
      pain: "Errors, stockouts, and lost revenue from outdated stock data.",
      solution: "Cloud based WMS with barcode and RFID tracking for real-time accuracy.",
    },
    {
      icon: Truck,
      title: "No real-time fleet visibility",
      pain: "Delayed dispatch and idle vehicles across your network.",
      solution: "GPS fleet management system with live tracking and driver alerts.",
    },
    {
      icon: Truck,
      title: "Inefficient routing and dispatch",
      pain: "Higher fuel costs and missed SLAs on every run.",
      solution: "TMS software with route optimization and automated load assignment.",
    },
    {
      icon: BarChart3,
      title: "Poor supply chain visibility",
      pain: "Blind spots across warehouses, carriers, and last-mile partners.",
      solution: "Supply chain management software with unified dashboards and alerts.",
    },
    {
      icon: Database,
      title: "Legacy systems won't integrate",
      pain: "Disconnected from ERP, SCM, and partner platforms.",
      solution: "API-first WMS and TMS with ERP/SCM integration and webhooks.",
    },
  ];

  const outcomes = [
    { value: "30–40%", label: "Faster Fulfillment" },
    { value: "98%+", label: "Inventory Accuracy" },
    { value: "25–35%", label: "Route Cost Savings" },
    { value: "20–30%", label: "Fleet Maintenance Savings" },
    { value: "Real-time", label: "SCM Visibility" },
    { value: "Scalable", label: "Cloud WMS & TMS" },
  ];
  ...
  const features = [
    {
      ...
      sections: [
        {
          heading: "For Warehouse Ops",
          details: [
            "Receiving and putaway workflows with barcode scanning",
            "Pick, pack, and ship with wave and batch picking",
            "Bin-level inventory and warehouse inventory management software",
            "Cross-dock and transfer order management",
            "Returns processing and quality holds",
            "Labor task assignment with performance metrics",
          ],
        },
        {
          heading: "For Managers",
          details: [
            "Live WMS dashboard across all locations",
            "Slotting and capacity utilization reports",
            "SLA and fulfillment KPI tracking",
            "User roles and audit trails for compliance",
          ],
        },
      ],
    },
    {
      ...
      sections: [
        {
          heading: "For Dispatch",
          details: [
            "Load planning and carrier rate comparison",
            "Automated dispatch and driver assignment",
            "Route optimization with traffic-aware routing",
            "Freight management software for LTL and FTL",
            "Document generation — BOL, labels, customs",
            "Exception alerts for delays and missed windows",
          ],
        },
        {
          heading: "For Carriers",
          details: [
            "Carrier portal for tender acceptance",
            "Proof of delivery capture and ePOD",
            "Freight invoice reconciliation",
            "Performance scorecards and on-time metrics",
          ],
        },
      ],
    },
    {
      id: "fleet-management-software",
      title: "Fleet Management Software",
      sections: [
        {
          heading: "For Fleet Managers",
          details: [
            "GPS fleet tracking across all vehicles",
            "Fleet maintenance software with preventive schedules",
            "Fuel management and cost per mile reporting",
            "Vehicle fleet management software compliance logs",
            "Geofencing and idle-time alerts",
            "Driver safety scoring and incident reports",
          ],
        },
        {
          heading: "For Drivers",
          details: [
            ...
            "Maintenance issue reporting from the road",
            "Hours-of-service and trip logs",
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          details: [
            "Stock management system software with cycle counts",
            "Lot, batch, and serial number tracking",
            "Min/max reorder alerts and auto-replenishment",
            "Mobile scanning for fast stock adjustments",
            "Quarantine and expiry date management",
          ],
        },
        {
          heading: "For Planners",
          details: [
            "Demand forecasting tied to inbound POs",
            "Multi-location inventory visibility",
            "ABC analysis and slow-mover reports",
      ...
      sections: [
        {
          ...
          details: [
            "End-to-end supply chain management software dashboards",
            "Supplier and carrier performance tracking",
            "Inbound and outbound milestone visibility",
            "SCM software alerts for disruptions",
            "Inventory in transit and dock scheduling",
          ],
        },
        {
          heading: "For Leadership",
          details: [
            "Executive KPIs — cost, OTIF, and fill rate",
            "Supply chain ERP integration summaries",
            "Scenario planning for peak demand",
            "Partner and 3PL scorecard rollups",
          ],
        },
      ],
    },
    {
      id: "freight-shipment-management",
      title: "Freight & Shipment Management",
      sections: [
        {
          heading: "For Logistics Teams",
          details: [
            "Multi-carrier freight booking and tracking",
            "Shipment consolidation and load building",
            "Customs and cross-border documentation",
            "Claims and damage workflow management",
        ...
        },
        {
          ...
          details: [
            "Branded shipment tracking portal",
            "Automated ETA and delivery notifications",
            "Proof of delivery and signature capture",
            "Returns and RMA self-service requests",
          ],
        },
      ],
    },
    {
      id: "3pl-warehouse-management",
      title: "3PL Warehouse Management",
      sections: [
        {
          heading: "For 3PL Operators",
          details: [
            "Multi-client 3PL WMS with segregated inventory",
            "Client-specific billing and activity-based pricing",
            "White-label client portals and reporting",
            "SLA monitoring per client contract",
            "Inbound ASN and outbound order orchestration",
          ],
        },
        {
          heading: "For Clients",
          details: [
            ...
            "Order status and fulfillment reports",
            "Billing transparency and storage metrics",
            "API access for e-commerce integrations",
          ],
        },
      ],
    },
    {
      id: "mobile-last-mile-delivery",
      title: "Mobile & Last-Mile Delivery",
      sections: [
        {
          heading: "For Drivers",
          details: [
            "Optimized stop sequences and navigation",
            "Electronic proof of delivery with photos",
            "Cash-on-delivery and signature capture",
            "Offline mode for low-connectivity routes",
        ...
        },
        {
          heading: "For Customers",
          details: [
            "Live delivery tracking on mobile",
            "Delivery window notifications via SMS or email",
            "Reschedule and safe-drop preferences",
            "Rate-and-review after completed delivery",
          ],
        },
      ],
    },
  ...
  const useCases = [
    {
      title: "3PL Warehouse Scaling WMS",
      problem:
        "A growing 3PL provider managed five clients on spreadsheets and a legacy WMS that couldn't scale.",
      solution:
        "Custom 3PL WMS with multi-client billing and client portals — 40% faster fulfillment and room to onboard new accounts without adding headcount.",
    },
    {
      title: "Trucking Company TMS Rollout",
      problem:
        "A regional trucking fleet relied on phone dispatch and paper logs, missing SLAs and overspending on fuel.",
      solution:
        "TMS trucking software with route optimization and GPS fleet tracking — 30% route cost savings and 98% on-time delivery within 90 days.",
    },
    {
      title: "Distributor WMS + SCM Integration",
      problem:
        "A wholesale distributor had no visibility between warehouse stock and inbound supplier shipments.",
      solution:
        "Integrated warehouse inventory management software and supply chain management software tied to their ERP — stockouts dropped 60% and planners gained real-time SCM visibility.",
    },
    {
      title: "Small Fleet GPS & Maintenance",
      problem:
        "A delivery company with 25 vehicles faced frequent breakdowns and no centralized fleet maintenance records.",
      solution:
        "Vehicle fleet management software with GPS fleet tracking and fleet maintenance software alerts — 25% maintenance cost reduction and zero unplanned downtime in Q1 post-launch.",
    },
  ];
  ...
  const processSteps = [
    {
      ...
      description:
        "We map your warehouse workflows, transport lanes, fleet assets, and integration points to define scope for WMS, TMS, and fleet modules.",
    },
    {
      number: "2",
      title: "Design WMS/TMS Architecture",
      description:
        "We design a cloud WMS and TMS architecture aligned to your ERP, carriers, and 3PL partners — with clear data flows and rollout phases.",
    },
    {
      number: "3",
      title: "Build + Integrate",
      description:
        "Our team develops and integrates your logistics management software with existing systems, carriers, and hardware with minimal disruption.",
    },
    {
      number: "4",
      title: "Train + Go Live",
      description:
        "We train warehouse, dispatch, and fleet teams, then go live with ongoing support to maximize adoption and ROI.",
    },
  ];
  ...
  const advantages = [
    {
      id: 1,
      title: "Logistics & WMS Expertise",
      description: "Deep experience building WMS, TMS, and fleet platforms for 3PLs and carriers.",
    },
    {
      id: 2,
      title: "Scalable Cloud Architecture",
      description: "Cloud based WMS and TMS that scale from one warehouse to a national network.",
    },
    {
      id: 3,
      title: "Modern TMS & Fleet Tech",
      description: "GPS fleet tracking, route optimization, and mobile apps built for the field.",
    },
    {
      id: 4,
      title: "Quality & Compliance",
      description: "Rigorous testing for accuracy, security, and industry compliance standards.",
    },
    {
      id: 5,
      title: "ERP/SCM Integration",
      description: "Seamless supply chain ERP and SCM software connections — SAP, Oracle, and more.",
    },
    {
      id: 6,
      title: "24/7 Support",
      description: "Round-the-clock support so your logistics operations never miss a beat.",
    },
  ];
  ...
  const relatedServices = [
    {
      ...
      description:
        "Purpose-built WMS, TMS, and fleet systems tailored to your logistics workflows.",
      href: ROUTES.service.customCrm,
    },
    {
      title: "AI/ML Development",
      description:
        "Demand forecasting, route optimization, and predictive fleet maintenance.",
      href: ROUTES.service.aiMl,
    },
    {
      title: "Digital Transformation",
      description:
        "A clear roadmap from manual logistics to a connected cloud WMS and TMS platform.",
      href: ROUTES.service.digitalTransformation,
    },
    {
      title: "Application Modernization",
      description:
        "Upgrade legacy warehouse and transport systems without disrupting operations.",
      href: ROUTES.service.applicationModernisation,
    },
    {
      title: "Mobile App Development",
      description:
        "Driver apps, warehouse scanners, and customer tracking portals on any device.",
  ...
  const relatedResources = [
    {
      topic: "Guides",
      title: "WMS Buyer Guide: Choosing Warehouse Management Software",
      href: "#",
    },
    {
      topic: "Whitepapers",
      title: "TMS for Trucking: A Fleet Dispatch & Route Optimization Playbook",
      href: "#",
    },
    {
      topic: "Guides",
      title: "Supply Chain Software Selection Guide",
      href: "#",
    },
  ];

  const faqs = LOGISTICS_FAQ_ITEMS.map((f, i) => ({
    id: i,
    title: f.question,
    content: f.answer,
  }));

  const pageUrl = absoluteUrl(ROUTES.industry.logistics);
  ...
  const jsonLdGraph = useMemo(() => {
    const faqSchema = {
      "@type": "FAQPage",
      "@id": `${pageUrl}#faq`,
      mainEntity: LOGISTICS_FAQ_ITEMS.map((f) => ({
        "@type": "Question",
        name: f.question,
        acceptedAnswer: {
          "@type": "Answer",
    ...
    const organizationSchema = {
      ...
      description:
        "Ascentia Labs builds custom logistics software, WMS, TMS, fleet management systems, and supply chain management platforms for 3PLs, carriers, and distributors.",
      contactPoint: {
        "@type": "ContactPoint",
        contactType: "sales",
    ...
    const serviceSchema = {
      "@type": "Service",
      "@id": `${pageUrl}#service`,
      name: "Custom Logistics Software Development — WMS, TMS & Fleet Management",
      serviceType: "Logistics Software Development",
      description: seoData.logistics.description,
      provider: { "@id": `${SITE_URL}/#organization` },
      url: pageUrl,
      hasOfferCatalog: {
        "@type": "OfferCatalog",
        name: "Logistics Software Features",
  ...
  useEffect(() => {
    const scriptId = "logistics-jsonld";
    ...
    <div className="min-h-screen bg-black">
      ...
      <nav aria-label="Breadcrumb" className="sr-only">
        <ol>
          ...
          <li>Industries</li>
          <li>
            <Link to={ROUTES.industry.logistics}>Logistics</Link>
          </li>
        </ol>
      </nav>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14 2xl:gap-20">
            <div className="max-w-3xl space-y-6 text-white">
              <h1 className="text-[25px] leading-tight md:text-4xl">
                Custom Logistics Software — WMS, TMS & Fleet Management
              </h1>

              <p className="text-lg leading-relaxed text-gray-300">
                Cloud based warehouse management and transportation management
                software that unifies WMS, TMS, fleet tracking, and supply chain
                visibility for 3PLs, trucking companies, and logistics teams.
              </p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-light leading-relaxed text-gray-300">
                          Real-time inventory, picking, and stock control
                          across locations.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="p-5 transition-colors duration-300 hover:bg-white/[0.04]">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-light leading-relaxed text-gray-300">
                          Plan routes, dispatch loads, and track shipments live.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-white/10 p-5 transition-colors duration-300 hover:bg-white/[0.04] sm:border-t">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-light leading-relaxed text-gray-300">
                          GPS tracking, maintenance alerts, and fuel management
                          in one platform.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="border-white/10 p-5 transition-colors duration-300 hover:bg-white/[0.04] sm:border-t">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-light leading-relaxed text-gray-300">
                          End-to-end visibility from warehouse to last-mile
                          delivery.
                        </p>
                      </div>
                    </div>
      ...
      <ChallengesPinnedSection
        ...
        title="Logistics Challenges We Solve"
        subtitle="WMS, TMS, and fleet operations face interconnected bottlenecks. Here's how we address each one."
      />
      ...
      <SectionShell gradient labelledBy="outcomes-heading">
        <SectionIntro
          id="outcomes-heading"
          title="Business Outcomes with Logistics Software"
          subtitle="Measurable results from unified warehouse management software, TMS, and fleet platforms."
          light
        />
      ...
      <SectionShell labelledBy="ai-solutions-heading">
        <SectionIntro
          ...
          title="Explore Top Features of Our Logistics Management Solutions"
          subtitle="Comprehensive WMS software, TMS software, fleet management, and SCM capabilities for modern logistics teams."
        />
        ...
        <div className="overflow-hidden rounded-2xl border border-white/10 bg-gray-950/80 shadow-xl">
          <div className="grid min-h-0 grid-cols-1 lg:min-h-[420px] lg:grid-cols-5">
            <nav
              ...
              aria-label="Logistics feature categories"
            >
      ...
      <SectionShell gradient labelledBy="use-cases-heading">
        <SectionIntro
          ...
          subtitle="See how logistics teams have transformed operations with custom WMS, TMS, and fleet software."
          light
        />
      ...
      <SectionShell labelledBy="process-heading">
        <SectionIntro
          id="process-heading"
          title="Our Logistics Software Implementation Process"
          subtitle="How we deliver your custom WMS, TMS, and fleet management platform."
        />
      ...
      <SectionShell gradient labelledBy="related-industries-heading">
        <SectionIntro
          ...
          subtitle="Explore custom software development across CRM, healthcare, ERP, manufacturing, and more."
          light
        />
            ...
            <div className="space-y-6 text-white">
              <div>
                ...
                <p className="text-xl text-gray-100">
                  Why Logistics Teams Choose Ascentia Labs
                </p>
              </div>
              <AccordionGroup
                items={reasons}
            ...
            <div className="lg:sticky lg:top-28">
              <div className="rounded-2xl border border-blue-400/25 bg-gradient-to-br from-blue-600/15 to-blue-900/30 p-8 text-center text-white backdrop-blur-md md:p-10">
                ...
                <p className="mb-7 leading-relaxed text-blue-100">
                  Join 3PLs, trucking companies, and distributors who trust our
                  logistics management software to unify WMS, TMS, and fleet
                  operations.
                </p>
                <button
                  type="button"
