                ...
                <div className="flex items-center justify-between gap-3 border-b border-white/10 bg-white/[0.04] px-4 py-3 sm:px-5 sm:py-3.5 2xl:px-6 2xl:py-4">
                  <div className="flex min-w-0 items-center gap-2.5">
                    ...
                    <p className="truncate text-sm font-normal text-white sm:text-base 2xl:text-lg">
                      Complete Canada PropTech Suite
                    </p>
                  </div>
                  ...
                  {[
                    {
                      ...
                      body: "Leasing CRM, Realtor.ca, and Rentals.ca listings.",
                      icon: Building,
                    ...
                    {
                      title: "Rent Control",
                      body: "Provincial rent caps, notices, and audit-ready docs.",
                      icon: ClipboardCheck,
                    ...
                    {
                      title: "Maintenance",
                      body: "Smart dispatch, vendor networks, and unit turns.",
                      icon: Wrench,
                    ...
                    {
                      title: "Resident Experience",
                      body: "Digital leases, online payments, and renewals.",
                      icon: MessageSquare,
