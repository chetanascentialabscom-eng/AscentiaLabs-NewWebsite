...
const BUSINESS_CRM_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "24/7 support, ongoing maintenance and continuous improvement to ensure lasting value from your CRM system.",
  },
];
...
const BusinessCrmPage = () => {
  ...
  /* ===========================================================
   * DATA — Business CRM content mapped to Field/RE section structure
   * =========================================================== */

  const challenges = [
    {
      problem: "Manual lead tracking spread across emails and spreadsheets.",
      impact: "Missed follow-ups and weaker conversion discipline.",
      solution:
    ...
    },
    {
      ...
      impact: "Fragmented customer context across teams.",
      solution:
    ...
    },
    {
      ...
      impact: "Decisions made without a clear pipeline view.",
      solution:
    ...
    },
    {
      ...
      impact: "Teams forced into workarounds that slow selling.",
      solution:
    ...
    },
    {
      ...
      impact: "Growing teams stuck without an affordable CRM path.",
      solution:
    ...
    },
    {
      ...
      impact: "Incomplete client history across tools.",
      solution:
  ...
  const outcomes = [
    ...
    { value: "85–92%", label: "Customer Retention Rate" },
    { value: "90%", label: "Faster Response Times" },
    { value: "60–70%", label: "Admin Overhead Reduction" },
    { value: "20–35%", label: "Sales Operations Cost Savings" },
  ...
  const useCases = [
    {
      title: "Small Business Sales CRM",
      problem:
        "A small business CRM search led a 20-person sales team to five disconnected spreadsheets.",
      solution:
        "A custom, easy-to-use CRM for small business unifying contacts, deals and tasks.",
      outcome: "35% increase in lead conversion, reps closing 25% more deals.",
    },
    {
      title: "Construction CRM",
      problem:
        "A construction company needed a CRM for general contractors to manage bids and clients.",
      solution:
        "Construction CRM software with project-linked client records and automated bid follow-up.",
      outcome: "40% faster bid turnaround, 20% more repeat business.",
    },
    {
      title: "Accounting Firm CRM",
      problem:
        "An accounting firm relied on a shared inbox to track every client relationship.",
      solution:
        "CRM for accounting firms with document tracking and automated client reminders.",
      outcome: "50% reduction in missed follow-ups, higher client retention.",
    },
    {
      title: "Startup CRM Scale-Up",
      problem:
        "A startup needed a free-to-start CRM that could scale with fundraising and growth.",
      solution:
        "Custom CRM development starting lean, built to scale into a full business CRM software suite.",
  ...
  const processSteps = [
    {
      number: "1",
      title: "Learn Your Sales Process",
      description:
        "We conduct comprehensive analysis of your sales, marketing and support operations, identifying key challenges and opportunities for a purpose-built CRM system.",
    },
    {
      number: "2",
      title: "Custom Design",
      description:
        "We design a tailored business CRM software platform that aligns with your business model, incorporating automation, predictive analytics and integrations.",
    },
    {
      number: "3",
      title: "Build + Test",
      description:
        "Our experts develop and deploy the CRM system with seamless integration to your existing ERP, accounting and marketing tools, with minimal disruption.",
    },
    {
      number: "4",
      title: "Train + Start",
      description:
        "We provide comprehensive training and ongoing support, continuously monitoring system performance to maximize adoption and ROI.",
    },
  ];
  ...
  const advantages = [
    {
      ...
      description:
        "We Know Business CRM — Across Real Estate, Construction, Accounting and More",
    },
    {
      id: 2,
      title: "Scalable Solutions",
      description:
        "Grows With You — From a 5-Person Startup to a 500-Seat Sales Org",
    },
    {
      id: 3,
      title: "Advanced Technology",
      description:
        "Modern Tech — AI Lead Scoring, Automation, Real-time Reports",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      description:
        "Works With Your Current ERP, Accounting and Marketing Tools",
    },
    {
      id: 6,
      title: "24/7 Support",
  ...
  const relatedServices = [
    {
      ...
      description:
        "Purpose-built CRM systems that match your exact sales and service workflow.",
      href: ROUTES.service.customCrm,
    },
    {
      title: "AI/ML Development",
      description:
        "Predictive lead scoring, churn prediction and customer analytics.",
      href: ROUTES.service.aiMl,
    },
    {
      title: "Digital Transformation",
      description:
        "A clear roadmap from spreadsheets to a connected CRM system.",
      href: ROUTES.service.digitalTransformation,
    },
    {
      title: "Application Modernization",
      description:
        "Upgrade legacy CRM systems without disrupting your sales team.",
      href: ROUTES.service.applicationModernisation,
    },
    {
      title: "Mobile App Development",
      description: "Manage leads, deals and clients from anywhere.",
  ...
  const relatedResources = [
    {
      topic: "Blogs",
      title: "Best CRM for Small Business — A 2026 Buyer's Guide",
      href: "#",
    },
    {
      topic: "Whitepapers",
      title: "The CRM Playbook — Choosing Build vs Buy for Small Business",
      href: "#",
    },
    {
      topic: "Guides",
      title: "Choosing the Right CRM System for Your Business",
      href: "#",
    },
  ];

  const faqs = BUSINESS_CRM_FAQ_ITEMS.map((f, i) => ({
    id: i,
    title: f.question,
    content: f.answer,
  }));

  const pageUrl = absoluteUrl(ROUTES.industry.businessCrm);
  ...
  const jsonLdGraph = useMemo(() => {
    const faqSchema = {
      "@type": "FAQPage",
      "@id": `${pageUrl}#faq`,
      mainEntity: BUSINESS_CRM_FAQ_ITEMS.map((f) => ({
        "@type": "Question",
        name: f.question,
        acceptedAnswer: {
          "@type": "Answer",
    ...
    const organizationSchema = {
      ...
      description:
        "Ascentia Labs builds custom software, AI/ML solutions, and digital platforms for industry-specific operations including business CRM.",
      contactPoint: {
        "@type": "ContactPoint",
        contactType: "sales",
    ...
    const serviceSchema = {
      "@type": "Service",
      "@id": `${pageUrl}#service`,
      name: "Custom Business CRM Software Development",
      serviceType: "Business CRM Development",
      description: seoData.businessCrm.description,
      provider: { "@id": `${SITE_URL}/#organization` },
      url: pageUrl,
      hasOfferCatalog: {
        "@type": "OfferCatalog",
        name: "Business CRM Features",
    ...
    const webPageSchema = {
      ...
      "@id": pageUrl,
      url: pageUrl,
      name: seoData.businessCrm.title,
      description: seoData.businessCrm.description,
  ...
  useEffect(() => {
    const scriptId = "business-crm-jsonld";
    ...
    <div className="min-h-screen bg-black">
      ...
      <nav aria-label="Breadcrumb" className="sr-only">
        <ol>
          ...
          <li>Industries</li>
          <li>
            <Link to={ROUTES.industry.businessCrm}>Business CRM</Link>
          </li>
        </ol>
      </nav>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-light leading-relaxed text-gray-300">
                          Auto-track deals and eliminate manual work.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-white/10 p-5 transition-colors duration-300 hover:bg-white/[0.04] sm:border-t">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-light leading-relaxed text-gray-300">
                          CRM and email marketing, fully connected.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-white/10 p-5 transition-colors duration-300 hover:bg-white/[0.04] sm:border-t">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-light leading-relaxed text-gray-300">
                          Track every call, ticket and resolution live.
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <SectionShell gradient labelledBy="outcomes-heading">
        <SectionIntro
          id="outcomes-heading"
          title="Business Outcomes with Business CRM"
          subtitle="Measurable gains teams track after going live—conversion, retention, speed, and pipeline visibility."
          light
        />
      ...
      <SectionShell labelledBy="ai-solutions-heading">
        <SectionIntro
          ...
          title="Explore Top Features of Our Business CRM Solutions"
          subtitle="End-to-end capabilities designed to unify sales, marketing, support, and client management."
        />
        ...
        <div className="overflow-hidden rounded-2xl border border-white/10 bg-gray-950/80 shadow-xl">
          <div className="grid min-h-0 grid-cols-1 lg:min-h-[420px] lg:grid-cols-5">
            <nav
              ...
              aria-label="Business CRM feature categories"
            >
      ...
      <SectionShell gradient labelledBy="use-cases-heading">
        <SectionIntro
          ...
          title="Business CRM Use Cases — Real Business Scenarios"
          subtitle="Not feature lists — real scenarios that solve your specific sales and client challenges."
          light
        />
      ...
      <SectionShell labelledBy="process-heading">
        <SectionIntro
          id="process-heading"
          title="Our Business CRM Implementation Process"
          subtitle="From discovery to support — delivered in clear phases around your sales workflow"
        />
          ...
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-14">
            <div className="space-y-6 text-white">
              <div>
                ...
                >
                  Ready to Build a Custom Business CRM?
                </h2>
                <p className="text-xl text-gray-100">
                  Why Ascentia Labs for Business CRM
                </p>
              </div>
              <AccordionGroup
                items={reasons}
            ...
            <div className="lg:sticky lg:top-28">
              <div className="rounded-2xl border border-blue-400/25 bg-gradient-to-br from-blue-600/15 to-blue-900/30 p-8 text-center text-white backdrop-blur-md md:p-10">
                ...
                <h3 className="mb-4 text-2xl leading-snug">
                  Talk to a Business CRM Expert
                </h3>
                <p className="mb-7 leading-relaxed text-blue-100">
                  Connect sales, support, and marketing in one affordable CRM
