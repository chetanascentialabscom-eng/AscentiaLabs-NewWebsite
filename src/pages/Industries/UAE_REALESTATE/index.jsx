    ...
    <div className="min-h-screen bg-black">
      ...
      <Shell labelledBy="stakeholders-heading" alt>
        ...
        <div
          ...
          className="grid items-start gap-8 rounded-2xl border border-white/10 bg-black/25 p-6 md:p-8 lg:grid-cols-2"
        >
          <div>
          ...
          <div
            className="hidden min-h-[220px] rounded-xl border border-white/10 bg-gradient-to-br from-slate-800/80 to-black lg:block"
            aria-hidden="true"
          />
        </div>
      </Shell>
