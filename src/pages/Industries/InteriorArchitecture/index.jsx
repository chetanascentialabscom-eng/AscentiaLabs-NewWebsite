        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-300">
              Witness our step by step process in creating exceptional interior design solutions.
            </p>
          </div>
                ...
                <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 backdrop-blur-md rounded-3xl p-8 border border-blue-400/30">
                  <div className="text-center text-white">
                    ...
                    <p className="text-blue-100 mb-6">
                      Join hundreds of satisfied clients who trust Ascentia Labs for their interior design solutions.
                    </p>
                    <button 
                      onClick={openConsultation}
