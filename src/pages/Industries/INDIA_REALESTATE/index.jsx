...
const IndiaRealEstatePage = () => {
  ...
  const challenges = [
    {
      challenge:
        "landlords struggle with tenant verification, rent defaults, and remote property oversight.",
      solution:
  ...
  const advantages = [
    ...
    },
    {
      ...
      description:
        "Landlord support across time zones with IST-aligned domestic teams.",
    },
    {
      id: 6,
  ...
  const faqs = [
    ...
    {
      question: "Does it support TDS deduction for  landlords?",
      answer:
        "Yes. TDS under Section 195 is built into accounting, with landlord documentation and compliance reporting.",
    },
    {
                  ...
                  {[
                    {
                      ...
                      body: "Leasing CRM, 99acres, and MagicBricks listings.",
                      icon: Building,
                    ...
                    {
                      title: "GST & TDS",
                      body: "GST-compliant billing and TDS under Section 195.",
                      icon: DollarSign,
                    ...
                    {
                      title: "Maintenance",
                      body: "Smart dispatch and vendor networks for communities.",
                      icon: Wrench,
                    ...
                    {
                      title: "Resident Experience",
                      body: "Digital onboarding, UPI payments, and rent reminders.",
                      icon: MessageSquare,
