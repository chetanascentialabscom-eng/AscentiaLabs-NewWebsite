              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="grid md:grid-cols-2 gap-6 my-8">
                  <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm">
                    ...
                    <h4 className="text-lg font-semibold text-gray-800 mb-2">Smart Task Management</h4>
                  ...
                  <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm">
                    ...
                    <h4 className="text-lg font-semibold text-gray-800 mb-2">Workflow Automation</h4>
                ...
                <div className="bg-gradient-to-r from-blue-600 to-black text-white p-8 rounded-xl my-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="text-lg font-semibold mb-1">Productivity Increase</div>
                    ...
                    <div>
                      ...
                      <div className="text-lg font-semibold mb-1">Teams Onboarded</div>
                      <div className="text-blue-100 text-sm">Organizations using the platform</div>
                    </div>
                    <div>
                      <div className="text-4xl font-bold text-blue-200 mb-2">1M+</div>
                      <div className="text-lg font-semibold mb-1">Tasks Completed</div>
                ...
                <div className="bg-gray-50 border-l-4 border-blue-600 p-6 rounded-r-lg italic">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-semibold text-gray-800">JusDoIt Team</div>
