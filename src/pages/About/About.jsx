...
const About = () => {
  ...
  const teamMembers = [
    {
      ...
      description:
        "A Computer Science Engineer & A Scale Expert, Built & Launched 4 Enterprise Solutions With 50+ Enterprise Users",
  ...
  const galleryImages = [
    {
      src: "/about/WhatsApp Image 2025-12-23 at 11.47.54 (2).jpeg",
      alt: "Team Building",
    },
    {
      src: "/about/WhatsApp Image 2025-12-23 at 11.47.54 (1).jpeg",
      alt: "Workspace",
    },
    {
      src: "/about/WhatsApp Image 2025-12-23 at 11.47.54.jpeg",
      alt: "Innovation Hub",
    },
    {
      src: "/about/WhatsApp Image 2025-12-23 at 11.47.53.jpeg",
      alt: "Team Meeting",
    },
    {
      src: "/about/WhatsApp Image 2025-12-23 at 11.47.55.jpeg",
      alt: "Team Gathering",
    },
    {
      src: "/about/WhatsApp Image 2025-12-23 at 11.47.55 (1).jpeg",
      alt: "Professional Event",
    },
    {
      src: "/about/WhatsApp Image 2025-12-23 at 11.37.07.jpeg",
      alt: "Company Milestone",
    },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-blue-950 to-black relative">
      ...
      {/* Company Overview */}
      <section
        className="pt-32 pb-32 md:pb-40 bg-slate-900/80 relative overflow-hidden"
        style={{ zIndex: 1 }}
      >
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl text-white mb-6 leading-tight">
                120+ Projects Delivered. <br className="sm:hidden" />
                4+ Countries. <br />1 Shared Goal
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-lg text-white leading-relaxed">
                  With A Proven Track Record Of Launching Our Own Proprietary
                  Enterprise Solutions—Now Trusted By Over{" "}
                  <span className="text-amber-400 font-semibold">120+</span>{" "}
                  Enterprise Users—We Have A Unique "Insider" Understanding Of
                  What It Takes To Scale. We Know The Stakes Because We've Been
                  In Your Shoes.
                </p>
                <p className="text-lg text-white leading-relaxed">
                  At Ascentia Labs, We Translate{" "}
                  <span className="text-amber-400 font-semibold">7+</span> Years
                  Of Product-Building Expertise Into A Competitive Edge For Our
                  Clients. Facilitating Clients Across{" "}
                  <span className="text-amber-400 font-semibold">4+</span>{" "}
                  Countries, We Don't Just Deliver Projects; We Engineer The
                  Digital Transformation That Allows You To Redefine What's
      ...
      {/* Core Team Section */}
      <section
        className="py-12 bg-slate-900/70 relative overflow-hidden"
        style={{ zIndex: 1 }}
      >
              ...
              {teamMembers.map((member, index) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-amber-400 mb-2 text-base">
                      {member.role}
                    </p>
      ...
      {/* Gallery Section */}
      <section
        className="py-20 bg-gradient-to-b from-slate-900/70 via-blue-950/70 to-black/70 relative overflow-hidden"
        style={{ zIndex: 1 }}
      >
        {/* Smooth transition gradient at top */}
      ...
      {/* Map Section */}
      <section
        className="py-20 bg-black/80 relative overflow-hidden"
        style={{ zIndex: 1 }}
      >
        {/* Smooth transition gradient at top */}
