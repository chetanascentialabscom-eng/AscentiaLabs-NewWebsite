                ...
                {teamMembers.map((member, index) => (
                  ...
                  >
                    <div className="flex flex-row gap-4 p-5">
                      {/* Profile Image */}
                      <div className="relative overflow-hidden w-20 h-20 md:w-24 md:h-24 rounded-xl bg-gradient-to-br from-slate-700 to-slate-800 flex-shrink-0">
                        <img 
                          src={member.image} 
                          alt={member.name}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-blue-200/80 text-sm leading-relaxed mb-2">{member.description}</p>
                        <p className="text-blue-300/60 text-xs mb-2">Education: {member.education}</p>
                        <a 
