  ...
  const marketingAdvantages = [
    {
      ...
      description: "We Put Users First — Always",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description: "Quick Prototypes — Fast Feedback",
    },
    {
      id: 4,
      title: "Brand Identity Excellence",
      description: "Memorable Brands — Lasting Impact",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      description: "Iterative Improvements — Better Results",
    },
  ];
  ...
  const services = [
    {
      ...
      description:
        "Our UX/UI experts create intuitive, beautiful and efficient user interfaces, facilitating seamless user experiences, optimizing usability, and ensuring visual consistency, to enhance customer satisfaction and drive engagement.",
      techLogos: [
    ...
    },
    {
      ...
      description:
        "Our branding experts develop compelling, memorable and cohesive brand identities, facilitating brand recognition, optimizing visual communication, and ensuring consistent messaging, to enhance brand value and market presence.",
      techLogos: [
        "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/photoshop/photoshop-plain.svg",
        "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg",
    ...
    },
    {
      ...
      description:
        "Our prototyping experts build interactive, realistic and testable prototypes, facilitating user testing, optimizing design validation, and ensuring functionality verification, to enhance product development and reduce risks.",
      techLogos: [
        "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg",
        "https://cdn.worldvectorlogo.com/logos/framer-motion.svg",
    ...
    },
    {
      ...
      description:
        "Our research experts conduct comprehensive, data-driven and insightful user research, facilitating informed design decisions, optimizing user understanding, and ensuring strategic planning, to enhance product-market fit and user satisfaction.",
      techLogos: [
  ...
  const faqs = [
    {
      ...
      answer:
        "We follow industry-standard methodologies including Design Thinking, Human-Centered Design, and Agile UX. Our approach ensures iterative design development, continuous user feedback, and seamless collaboration with development teams.",
    },
    {
      question: "How long does it take to complete a design project?",
      answer:
        "Design timelines vary based on complexity and scope. Simple UI designs can be delivered in 2-4 weeks, while comprehensive brand identity and UX projects may take 2-3 months or more. We provide detailed timelines during the planning phase.",
    },
    {
      question: "Do you provide design system documentation?",
      answer:
        "Yes, we offer comprehensive design system documentation including component libraries, style guides, design tokens, and usage guidelines to ensure consistency across your product and enable efficient collaboration between design and development teams.",
    },
    {
      question: "Can you redesign our existing product?",
      answer:
        "Absolutely. We specialize in product redesigns and can audit your existing design, identify improvement opportunities, and create a modernized, user-friendly interface that aligns with current design trends and best practices.",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl  mb-4 sm:mb-6 leading-tight">
                Ideation & Design That Turns Your Ideas Into Real Products
              </h1>
              <p className="text-base sm:text-lg text-blue-100 mb-6 sm:mb-8 leading-relaxed">
                At Ascentia Labs, we help you stop wasting money on designs that
                users hate. We turn your ideas into real products with designs
                that users love. Our expert team creates simple, beautiful
                designs using tools that work.
              </p>
              ...
              <div className="text-white space-y-8">
                <div>
                  ...
                  <p className="text-xl text-gray-300 mb-8">
                    Here's Why Creative Businesses Choose Us For Design
                    Excellence!
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 backdrop-blur-md rounded-3xl p-8 border border-blue-400/30">
                  <div className="text-center text-white">
                    ...
                    <p className="text-blue-100 mb-6">
                      Join 300+ design projects and create stunning user
                      experiences with innovative solutions from Ascentia Labs.
                    </p>
                    <button
                      onClick={openConsultation}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto">
              Work with design professionals who transform ideas into compelling
              visual experiences
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="bg-gray-900 rounded-2xl border border-gray-700 overflow-hidden hover:border-blue-500 transition-all duration-300 hover:shadow-lg"
              >
                <button
