...
const IdeationDesign = () => {
  ...
  const whyChooseUs = [
    {
      ...
      title: "Proven Experience in Design",
      description: "Ascentia Labs boasts a proven track record in crafting innovative, user-centric and impactful design solutions. With 10+ years of experience, our team of experts have helped businesses across various industries by leveraging the power of creative design thinking."
    },
    {
      icon: <Lock className="w-8 h-8" />,
      title: "User-Focused Approach",
      description: "We prioritize creating intuitive and engaging user experiences with industry-leading design principles. Our design solutions leverage user research and testing to ensure your product resonates with your target audience."
    },
    {
      icon: <TrendingUp className="w-8 h-8" />,
      title: "Scalability & Flexibility",
      description: "Our Experts build scalable design systems designed to grow alongside your business. We utilize flexible design frameworks to tailor fit your specific needs. This ensures your design can adapt to evolving requirements, future-proofing your investment."
    },
    {
  ...
  const stats = [
    { number: '300+', label: 'Design Projects Delivered' },
            ...
            <div className="mt-8 lg:mt-0">
              ...
              <div className="flex justify-center mb-6 animate-fadeIn">
                <div className="bg-white/15 backdrop-blur-lg rounded-full border border-white/30 shadow-2xl px-5 py-2.5 hover:scale-105 transition-transform duration-300 cursor-pointer">
                  <div className="flex items-center gap-2.5">
                    ...
                    <h3 className="text-sm sm:text-base font-bold text-white">Design Excellence</h3>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl p-5 sm:p-6 cursor-pointer group flex flex-col items-center justify-center text-center min-h-[140px] sm:min-h-[160px] transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:bg-white/25 hover:border-white/60 hover:shadow-2xl hover:shadow-blue-500/50 overflow-hidden">
                  ...
                  <h4 className="text-sm sm:text-base font-bold text-white mb-1.5 relative z-10">UX/UI Design</h4>
                ...
                <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl p-5 sm:p-6 cursor-pointer group flex flex-col items-center justify-center text-center min-h-[140px] sm:min-h-[160px] transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:bg-white/25 hover:border-white/60 hover:shadow-2xl hover:shadow-blue-500/50 overflow-hidden">
                  ...
                  <h4 className="text-sm sm:text-base font-bold text-white mb-1.5 relative z-10">Brand Identity</h4>
                ...
                <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl p-5 sm:p-6 cursor-pointer group flex flex-col items-center justify-center text-center min-h-[140px] sm:min-h-[160px] transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:bg-white/25 hover:border-white/60 hover:shadow-2xl hover:shadow-blue-500/50 overflow-hidden">
                  ...
                  <h4 className="text-sm sm:text-base font-bold text-white mb-1.5 relative z-10">Prototyping</h4>
                ...
                <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl p-5 sm:p-6 cursor-pointer group flex flex-col items-center justify-center text-center min-h-[140px] sm:min-h-[160px] transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:bg-white/25 hover:border-white/60 hover:shadow-2xl hover:shadow-blue-500/50 overflow-hidden">
                  ...
                  <h4 className="text-sm sm:text-base font-bold text-white mb-1.5 relative z-10">User Research</h4>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience the advantages of working with design experts who understand your business needs
            </p>
          </div>
