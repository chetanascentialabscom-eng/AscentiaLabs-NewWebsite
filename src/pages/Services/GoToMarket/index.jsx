  ...
  const marketingAdvantages = [
    {
      ...
      description: "We Use Real Data — Not Guesses",
    },
    {
      id: 2,
      title: "Multi-Channel Marketing",
      description: "Reach Customers Everywhere — Online + Offline",
    },
    {
      id: 3,
      title: "Sales Funnel Optimization",
      description: "Turn More Leads Into Buyers",
    },
    {
      id: 4,
      title: "Competitive Market Analysis",
      description: "Know Your Competitors — Beat Them",
    },
    {
      id: 5,
      title: "Performance Tracking & Analytics",
      description: "Track Results Daily — Fix Fast",
    },
    {
      id: 6,
      title: "Continuous Campaign Optimization",
      description: "Improve Campaigns Weekly — Get Better Results",
    },
  ];
  ...
  const services = [
    {
      ...
      description:
        "Our strategy experts create comprehensive, data-driven and actionable go-to-market plans, facilitating market entry, optimizing positioning, and ensuring competitive advantage, to enhance product success and drive revenue growth.",
      techLogos: [
    ...
    },
    {
      ...
      description:
        "Our marketing experts develop targeted, engaging and measurable digital campaigns, facilitating brand awareness, optimizing customer acquisition, and ensuring ROI maximization, to enhance market presence and drive conversions.",
      techLogos: [
        "https://www.gstatic.com/analytics-suite/header/suite/v2/ic_analytics.svg",
        "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/googlecloud/googlecloud-original.svg",
        "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/salesforce/salesforce-original.svg",
    ...
    },
    {
      ...
      description:
        "Our sales experts implement effective, scalable and results-driven sales strategies, facilitating pipeline development, optimizing conversion rates, and ensuring revenue targets, to enhance sales performance and market penetration.",
      techLogos: [
        "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/salesforce/salesforce-original.svg",
        "https://www.gstatic.com/analytics-suite/header/suite/v2/ic_analytics.svg",
        "https://upload.wikimedia.org/wikipedia/commons/c/cf/New_Power_BI_Logo.svg",
    ...
    },
    {
      ...
      description:
        "Our analytics experts conduct thorough, insightful and actionable market research, facilitating informed decisions, optimizing market understanding, and ensuring strategic positioning, to enhance competitive advantage and market success.",
      techLogos: [
        "https://www.gstatic.com/analytics-suite/header/suite/v2/ic_analytics.svg",
        "https://upload.wikimedia.org/wikipedia/commons/c/cf/New_Power_BI_Logo.svg",
        "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg",
  ...
  const faqs = [
    {
      ...
      answer:
        "We follow industry-proven frameworks including Product-Market Fit analysis, TAM-SAM-SOM methodology, and Growth Hacking strategies. Our approach ensures comprehensive market analysis, strategic positioning, and measurable launch success.",
    },
    {
      question: "How long does it take to develop a go-to-market strategy?",
      answer:
        "Strategy development timelines vary based on market complexity and product scope. Basic GTM strategies can be delivered in 4-6 weeks, while comprehensive enterprise market entry strategies may take 3-4 months. We provide detailed timelines during the planning phase.",
    },
    {
      question: "Do you provide post-launch support and optimization?",
      answer:
        "Yes, we offer comprehensive post-launch support including performance monitoring, campaign optimization, A/B testing, market feedback analysis, and strategy refinement to ensure your product achieves sustained market success and growth.",
    },
    {
      question: "Can you help with international market expansion?",
      answer:
        "Absolutely. We specialize in international go-to-market strategies and can conduct market research, localization planning, competitive analysis, and develop region-specific strategies to ensure successful expansion into new geographic markets.",
    },
  ];

  return (
    <div className="min-h-screen bg-white">
      <SEO {...seoData.goToMarket} />
      {/* Hero Section */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-base sm:text-lg text-blue-100 mb-6 sm:mb-8 leading-relaxed">
                At Ascentia Labs, we deliver cutting-edge go-to-market
                strategies that transform your product launch into market
                success. Our expert team specializes in creating data-driven,
                comprehensive, and results-oriented market strategies using the
                latest tools and best practices in product marketing.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl p-5 sm:p-6 cursor-pointer group flex flex-col items-center justify-center text-center min-h-[140px] sm:min-h-[160px] transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:bg-white/25 hover:border-white/60 hover:shadow-2xl hover:shadow-blue-500/50 overflow-hidden">
                  ...
                  <p className="text-xs text-blue-100 leading-tight relative z-10 group-hover:text-white transition-colors duration-300">
                    Find your target customers, position your product right,
                ...
                <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl p-5 sm:p-6 cursor-pointer group flex flex-col items-center justify-center text-center min-h-[140px] sm:min-h-[160px] transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:bg-white/25 hover:border-white/60 hover:shadow-2xl hover:shadow-blue-500/50 overflow-hidden">
                  ...
                  <p className="text-xs text-blue-100 leading-tight relative z-10 group-hover:text-white transition-colors duration-300">
                    Run campaigns that reach customers where they shop online.
                  </p>
                </div>
                ...
                <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl p-5 sm:p-6 cursor-pointer group flex flex-col items-center justify-center text-center min-h-[140px] sm:min-h-[160px] transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:bg-white/25 hover:border-white/60 hover:shadow-2xl hover:shadow-blue-500/50 overflow-hidden">
                  ...
                  <p className="text-xs text-blue-100 leading-tight relative z-10 group-hover:text-white transition-colors duration-300">
                    Sales Strategy That Closed Deals Faster
                  </p>
                </div>
                ...
                <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl p-5 sm:p-6 cursor-pointer group flex flex-col items-center justify-center text-center min-h-[140px] sm:min-h-[160px] transition-all duration-500 hover:scale-105 hover:-translate-y-3 hover:bg-white/25 hover:border-white/60 hover:shadow-2xl hover:shadow-blue-500/50 overflow-hidden">
                  ...
                  <p className="text-xs text-blue-100 leading-tight relative z-10 group-hover:text-white transition-colors duration-300">
                    Train your sales team, give them tools to close deals
                    faster.
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-400 max-w-3xl mx-auto">
              Comprehensive market launch solutions tailored to your business
              needs that help you launch products successfully.
            </p>
          </div>
              ...
              <div className="text-white space-y-8">
                <div>
                  ...
                  <p className="text-xl text-gray-300 mb-8">
                    Here's Why Market Leaders Choose Us For Go-To-Market
                    Excellence!
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-600/20 to-blue-800/20 backdrop-blur-md rounded-3xl p-8 border border-blue-400/30">
                  <div className="text-center text-white">
                    ...
                    <p className="text-blue-100 mb-6">
                      Join 150+ successful launches and achieve market success
                      with strategic solutions from Ascentia Labs.
                    </p>
                    <button
                      onClick={openConsultation}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              Work with Go-to-market experts who help you launch faster and sell
              more
            </p>
          </div>
