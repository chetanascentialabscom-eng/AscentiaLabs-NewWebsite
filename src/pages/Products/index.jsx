                ...
                {PRODUCT_CATEGORIES.map((category) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative pb-2 text-sm transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-400 md:text-[15px] ${
                        selected
