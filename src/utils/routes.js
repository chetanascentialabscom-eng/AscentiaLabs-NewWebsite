...
export const SLUGS = {
  industry: {
    ...
    usaHealthcare: "usa-healthcare-software-development",
    ...
    indiaRealEstate: "india-real-estate-software-development",
    canadaRealEstate: "canada-real-estate-software-development",
    australiaRealEstate: "australia-real-estate-software-development",
    ukRealEstate: "uk-real-estate-software-development",
...
export const ROUTES = {
  ...
  industry: {
    ...
    usaHealthcare: industryPath(SLUGS.industry.usaHealthcare),
    ...
    indiaRealEstate: industryPath(SLUGS.industry.indiaRealEstate),
    canadaRealEstate: industryPath(SLUGS.industry.canadaRealEstate),
    australiaRealEstate: industryPath(SLUGS.industry.australiaRealEstate),
    ukRealEstate: industryPath(SLUGS.industry.ukRealEstate),
...
export const LEGACY_REDIRECTS = [
  ...
  [
    "/usa-healthcare-software-development",
    ROUTES.industry.usaHealthcare,
  ],
  [
    "/india-healthcare-software-development",
    ROUTES.industry.indiaHealthcare,
  ],
  [
    "/uk-healthcare-software-development",
    ROUTES.industry.ukHealthcare,
  ],
  [
  ...
  ["/india-real-estate-software-development", ROUTES.industry.indiaRealEstate],
  ["/canada-real-estate-software-development", ROUTES.industry.canadaRealEstate],
  ["/australia-real-estate-software-development", ROUTES.industry.australiaRealEstate],
  ["/uk-real-estate-software-development", ROUTES.industry.ukRealEstate],
  ...
  [
    "/usa-textile-software-development",
