          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.instagram.com/ascentialabs/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center hover:scale-110 transition-all duration-300">
                  <svg className="w-6 h-6 text-[#E1306C] hover:opacity-80" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://wa.me/61412566906" target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center hover:scale-110 transition-all duration-300">
                  <svg className="w-6 h-6 text-[#25D366] hover:text-[#128C7E]" fill="currentColor" viewBox="0 0 24 24">
