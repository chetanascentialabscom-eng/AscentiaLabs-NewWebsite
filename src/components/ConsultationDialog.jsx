  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black/70 backdrop-blur-sm" style={{ pointerEvents: 'auto' }}>
      <div className="fixed inset-0 flex items-center justify-center p-4">
        ...
        <div 
          ref={dialogRef}
          className="relative bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 rounded-2xl shadow-2xl w-full max-w-4xl h-[90vh] flex flex-col border border-blue-200/50"
          onClick={(e) => e.stopPropagation()}
          style={{ pointerEvents: 'auto' }}
        >
        {/* Header */}
        <div className="flex-shrink-0 bg-gradient-to-r from-blue-600 via-blue-700 to-slate-800 text-white p-4 md:p-6 rounded-t-2xl shadow-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="w-8 h-8 md:w-12 md:h-12 bg-white/30 backdrop-blur-sm rounded-full flex items-center justify-center mr-3 md:mr-4 ">
              ...
              <div>
                ...
                <p className="text-blue-100/90 text-xs md:text-sm mt-1 hidden sm:block">Let's discuss your project</p>
              </div>
            </div>
            <button
              onClick={onClose}
              className="w-8 h-8 md:w-10 md:h-10  cursor-pointer rounded-full flex items-center justify-center transition-all duration-200 hover:scale-105 border border-white/20 flex-shrink-0"
            >
        ...
        <div 
          className="flex-1 p-6 md:p-8 overflow-y-auto scrollbar-hide"
          style={{ 
        ...
        >
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border-0 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition-all duration-200 bg-white shadow-sm hover:shadow-md"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="phone" className="flex items-center text-sm font-semibold text-gray-800 mb-3">
              ...
              <div>
                <label htmlFor="companyName" className="flex items-center text-sm font-semibold text-gray-800 mb-3">
              ...
              <div>
                ...
                <div className="relative" ref={countryDropdownRef}>
                  <button
                    ...
                    className="w-full px-4 py-3 border-0 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition-all duration-200 bg-white cursor-pointer text-sm text-gray-700 font-medium shadow-sm hover:shadow-md hover:border-blue-300 flex items-center justify-between"
                  >
                    <span className="truncate flex-1 text-left">
                      {formData.country || 'Select your country'}
                    </span>
                    <svg 
                      className={`w-4 h-4 ml-3 flex-shrink-0 transition-transform duration-200 text-blue-600 ${isCountryDropdownOpen ? 'rotate-180' : ''}`}
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
                  ...
                  {isCountryDropdownOpen && (
                    <div 
                      className="absolute top-full left-0 mt-2 bg-white border-2 border-blue-200 rounded-xl shadow-xl overflow-hidden w-full z-50 max-h-60 overflow-y-auto custom-scrollbar"
                    >
              ...
              <div>
                ...
                <div className="relative" ref={budgetDropdownRef}>
                  ...
                  >
                    ...
                    <svg 
                      className={`w-4 h-4 ml-3 flex-shrink-0 transition-transform duration-200 text-blue-600 ${isBudgetDropdownOpen ? 'rotate-180' : ''}`}
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
            ...
            {/* Message Field */}
            <div>
              <label htmlFor="message" className="flex items-center text-sm font-semibold text-gray-800 mb-3">
              ...
              <textarea
                ...
                required
                rows={5}
                className="w-full px-4 py-3 border-0 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition-all duration-200 resize-none bg-white shadow-sm hover:shadow-md"
              ...
              <button
                ...
                className={`px-10 py-4 rounded-full font-bold text-white transition-all duration-300 shadow-lg ${
                  isSubmitting
                    ...
                    : 'bg-gradient-to-r from-blue-600 via-blue-700 to-slate-800 hover:from-blue-700 hover:via-blue-800 hover:to-slate-900 hover:shadow-xl transform hover:scale-105 hover:shadow-blue-500/25'
                }`}
              >
                {isSubmitting ? (
                  <div className="flex items-center">
