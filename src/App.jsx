      ...
      <ConsultationProvider>
        ...
        <div className="min-h-screen">
          ...
          <Routes>
            ...
            />
            <Route
              path={ROUTES.industry.australiaRealEstate}
              element={<AustraliaRealEstatePage />}
            />
            <Route
              path={ROUTES.industry.ukRealEstate}
              element={<UKRealEstatePage />}
            />
            <Route
            ...
            />
            <Route
              path={ROUTES.industry.indiaTextile}
              element={<IndiaTextilePage />}
            />
            <Route
              path={ROUTES.industry.uaeTextile}
              element={<UAETextilePage />}
            />
            <Route
